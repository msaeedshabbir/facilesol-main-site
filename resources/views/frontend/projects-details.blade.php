        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-info text-center">
                    ...
                    <p class="text-white "><a href="{{ url('/') }}">Home</a><i class="far fa-chevron-double-right"></i> Project Details</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="details-area pt-120 pb-120">
    <div class="container">
        ...
        <div class="row mt-60 justify-content-center">
            <div class="col-lg-11">
                <img class="w-100 mb-4" src="assets/images/project/project-details.png" alt="">
                ...
                <article>
                    ...
                    <div class="related-project pt-5 mt-5">
                        ...
                        <div class="row mt-2 gy-4">
                            <div class="col-sm-6">
                                <img class="w-100" src="assets/images/project/related-1.png" alt="">
                            </div>
                            <div class="col-sm-6">
                                <img class="w-100" src="assets/images/project/related-2.png" alt="">
                            </div>
                        </div>
                    </div>
                </article>
